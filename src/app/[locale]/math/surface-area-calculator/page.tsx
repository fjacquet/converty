...
import { SurfaceAreaCalculator } from "./surface-area-calculator";
...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "converters.surface-area-calculator" });
...
export default async function SurfaceAreaCalculatorPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
