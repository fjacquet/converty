...
describe("calculateHex", () => {
  describe("hexToDecimal", () => {
    it("returns null for invalid hex string", () => {
      expect(calculateHex({ mode: "hexToDecimal", hex: "GGG" })).toBeNull();
    });
  ...
  describe("decimalToHex", () => {
    it("returns null for non-integer input", () => {
      expect(calculateHex({ mode: "decimalToHex", decimal: 3.5 })).toBeNull();
    });
  ...
  describe("hexToRgb", () => {
    ...
    it("returns null for invalid hex color", () => {
      expect(calculateHex({ mode: "hexToRgb", hex: "ZZZZZZ" })).toBeNull();
    });
  });
  ...
  describe("rgbToHex", () => {
    ...
    it("returns null for out-of-range RGB values", () => {
      expect(calculateHex({ mode: "rgbToHex", rgb: { r: 256, g: 0, b: 0 } })).toBeNull();
    });
  });
});
